...
<head>
    ...
    <title>Corsidea | Laurea & Recupero </title>
    ...
    <div class="wrapp-content">
        ...
        <div class="form-container">
            <form id="quote-form" action="send-form.php" method="post">
                ...
                <input type="hidden" name="form_type" value="laurea" />
                <h2 style="text-align: center;"> Recupera anni scolastici, lauree e master con percorsi su misura!</h2>
                <div class="form-step ">
                    <label for="course-level">Quale tipologia di corso di laurea ti interessa?</label>
                    <select id="course-level" required>
                        <option value="" disabled selected>Seleziona un livello</option>
                        <option value="triennale">Laurea Triennale</option>
                        <option value="magistrale">Laurea Magistrale</option>
                        <option value="master-primo">Master Primo Livello</option>
                        <option value="master-secondo">Master Secondo Livello</option>
                        <option value="recupero-scuola">Recupero Scuola</option>
                    </select>
                </div>
                <div class="form-step">
                    <label for="course-interest">A quale corso sei interessato?</label><br>
                    <select id="course-interest" required>
                ...
                <div class="form-step">
                    ...
                    <div class="policy-group">
                        <p>Compilando questo modulo di richiesta dichiaro di essere maggiorenne e di accettare i
                            Termini
                            e
                            <a href="privacy-laurea.html">Privacy Policy</a> di Corsidea.
