...
<head>
    ...
    <title>Corsidea | Corsi Professionali </title>
    ...
    <div class="wrapp-content">
        ...
        <div class="form-container">
            <form id="quote-form" action="send-form.php" method="post">
                ...
                <input type="hidden" name="form_type" value="corsi" />
                <h2 style="text-align: center;">Specializzati e avanza nella tua carriera con i migliori corsi
                    professionali per ogni settore!</h2>
                <div class="form-step ">
                    <label for="course-level-professionale">Quale tipologia di corso professionale ti interessa?</label>
                    <select id="course-level-professionale" required>
                        <option value="" disabled selected>Seleziona un corso</option>
                        <option value="AmministrazioneAziendale">Amministrazione Aziendale</option>
                        <option value="CreazioneeDesign">Creazione e Design</option>
                        <option value="Finanza">Finanza</option>
                        <option value="Informatica">Informatica</option>
                        <option value="Lingua">Lingua</option>
                        <option value="Logistica">Logistica</option>
                        <option value="Marketing">Marketing e Vendita</option>
                        <option value="Scienze">Scienze</option>
                        <option value="Sport">Sport</option>
                        <option value="Medicina">Medicina</option>
                        <option value="Altro">Compila il campo sottostante</option>

                    </select>
                </div>

                <div class="form-step ">
                    <label for="range">Inserisci il corso a cui sei interessato(Non obbligatorio)! </label>
                    <br>
                    <input name="altrocorso" type="text" id="altrocorso"
                        placeholder="Compila questo campo se il corso a cui sei interessato non è elencato">
                </div>
                ...
                <div class="form-step">
                    ...
                    <div class="policy-group">
                        ...
                        <label for="privacy-policy">Fornisco il consenso al trattamento dei miei dati personali per
                            essere
                    ...
                    <div class="policy-group">
                        ...
                        <label for="newsletter">Fornisco il consenso ad Adextra Italia S.r.l.s. al trattamento dei
                            miei
                            dati personali che saranno inseriti in un database per l’invio di comunicazioni
                            promozionali, newsletter, materiale pubblicitario, per mezzo di sistemi tradizionali di
                            contatto e sistemi informatici automatizzati, ivi incluse comunicazioni commerciali o
                            promozionali a mezzo e-mail o tramite social network, ovvero per ricerche ed analisi di
                            mercato.
                        </label>
                    </div>
                    <div class="policy-group">
                        <input type="checkbox" name="materiale" id="materiale">
                        <label for="materiale">Fornisco il consenso ad Adextra Italia S.r.l.s. a comunicare e
                            condividere i dati dell’utente a soggetti terzi per la ricezione di materiale
                            promozionale,
                            di
                            digital marketing ed e-commerce.</label>
                    </div>
                    <div class="policy-group">
                        <p>Compilando questo modulo di richiesta dichiaro di essere maggiorenne e di accettare i
                            Termini
                            e
                            <a href="privacy-professionali.html">Privacy Policy</a> di Corsidea.
...
<script type="text/javascript">
    var _iub = _iub || [];
    _iub.csConfiguration = { "siteId": 3850995, "cookiePolicyId": 79319840, "lang": "it", "storage": { "useSiteId": true } };
</script>
